...
//shortcuts for .resolve / .reject / .catch
var promise = Promise.resolve('This is just a test');

var promise = Promise.reject(new Error('I have been rejected once again'));

promise.catch(function (err) {
  console.error('Danger Danger there has been an error');
  console.error(err.message);
});
