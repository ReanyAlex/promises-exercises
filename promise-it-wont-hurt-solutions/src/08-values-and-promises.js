...
//created a function that returns a value and action
function attachTitle(arg) {
  return 'DR. ' + arg
}

//create a promise and resolve it with a value
Promise.resolve('MANHATTAN')
//pass the promise object to the next promise and call the above function
.then(attachTitle)
//log the results of the promise using the value and function 
.then(console.log);
